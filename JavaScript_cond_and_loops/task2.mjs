...
function gradeEvaluator(grade) {
  ...
  switch (true) {
    ...
    case grade >= 81 && grade <= 90:
      console.log(
        `Mark acception confirmed, your grade is: Дуже добре\n Thank you for using our grade tracking system`,
      );
      break;

    case grade >= 71 && grade <= 80:
      console.log(
        `Mark acception confirmed, your grade is: Добре\n Thank you for using our grade tracking system`,
      );
      break;

    case grade >= 60 && grade <= 70:
      console.log(
        `Mark acception confirmed, your grade is: Задовільно\n Thank you for using our grade tracking system`,
      );
      break;

    case grade >= 51 && grade <= 60:
      console.log(
        `Mark acception confirmed, your grade is: Незадовільно\n Thank you for using our grade tracking system`,
      );
      break;
