...
const sherlokHolmes = new Book("Sherlok Holmes", "Arthur Conan Doyle", 1998, 100)
sherlokHolmes.printInfo();

const charlieAndTheChocolateFactory = new Book("Charlie and the Chocolate Factory", "Roald Dahl", 1971, 52352000)
